...
export class MemberListComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit(): void {
    this.componentMetricsService.endRender(
      'members_render_time',
      'Render time for members-list component'
    );
  }

  ngOnDestroy(): void {
    this.componentMetricsService.endSession(
      'members_user_session',
